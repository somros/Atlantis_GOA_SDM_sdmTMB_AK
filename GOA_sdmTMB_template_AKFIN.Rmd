...
write.csv(x = out, file = paste0("C:/Users/Alberto Rovellini/Documents/GOA/SDM/sdmTMB_stages/output/cpue_tables/",race_data$name[1],race_data$stage[1],"_AFSC.csv"), row.names = FALSE)
```
...
write.csv(x = val, file = paste0("C:/Users/Alberto Rovellini/Documents/GOA/SDM/sdmTMB_stages/output/validation_tables/",race_data$name[1],race_data$stage[1],"_AFSC.csv"), row.names = FALSE)
```
